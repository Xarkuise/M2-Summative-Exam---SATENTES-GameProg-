export default class winningScene2 extends Phaser.Scene {
    constructor() {
        super("winningScene2");
    }
    ...
    preload() {
        ...
        this.load.image('gSBackground2', 'assets/images/background/SecondWinningBG.png');
    ...
    create() {
        ...
        this.winningBackground = this.add.image(0, 0, 'gSBackground2').setOrigin(0, 0);
        ...
        restartButton.on('pointerdown', () => {
            ...
            this.scene.start('gameBootScene3', { score: this.score, hearts: this.hearts });
        });  
